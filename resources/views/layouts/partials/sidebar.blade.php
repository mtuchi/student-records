      ...
      <div class="boxed-group-inner">
        ...
        <ul class="mini-class-list js-class-list">
          @foreach($teachers as $teacher)
						{{-- {{ dd($teacher) }} --}}
						{{-- <li><a href="{{ route('quarter.show',[$teacher->grade->slug,$teacher->subject->name]) }}">{{ $teacher->subject->name }}</a></li> --}}
          @endforeach
        </ul>
      </div>
    </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="boxed-group-inner">
          ...
          <ul class="mini-class-list js-class-list">
            <li><a href="{{ route('grade.show',$grade->slug) }}">{{ $grade->name }}</a></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">@ {{ $grade->name  }} Class, Teachers List</div>
      <div class="panel-body">
        <div class="boxed-group-inner">
