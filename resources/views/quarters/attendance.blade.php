      ...
      <div class="panel panel-default">
        <div class="panel-heading">Dashboard
          <div class="pull-right" style="margin-top:-7.5px;">
            {{-- <a href="{{ route('get.export',$grade->slug)}}" class="btn btn-success">Download Sheet</a>
            <a href="{{ route('get.upload',$grade->slug)}}" class="btn btn-primary">Upload Worksheet <i class="glyphicon glyphicon-download"></i></a> --}}
                ...
                @if(count($quarter->attendance))
                  @foreach($quarter->attendance as $attendance)
                    <tr class="record-row">
                        ...
                        <td class="actions">
                          <a href="{{ route('show.attendance', [$grade->slug,$quarter->slug,$attendance->student_id])}}" class="btn-link btn-xs text-info text-uppercase"> <b>edit</b></a>
                        </td>
                    </tr>
                  @endforeach
                @else
