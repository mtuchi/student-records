@if (count($student->grade) === 1)
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="row">
		@foreach ($student->grade as $grade)
			<h5 class="col-md-8 text-left text-capitalize text-muted"><strong>{{ $student->name }}</strong> belongs to {{ $grade->name }}</h5>
		@endforeach
			<div class="col-md-4">
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form" method="post" action="{{ route('student.assign', $student->id) }}">
				{{ csrf_field() }}
